...
\begin{definicija}
   \emph{Magični kvadrat} reda $n$ je \emph{normalen}, če v njem nastopajo števila
   \begin{equation}
      % oznaka: eq:numbers
...
\begin{figure} [!ht]
   \centering
   \caption{Paisjonska fasada, Sagrada Família}
...
% Začetek tabele
 ...
 \begin{table}[h]   
   ...
   \begin{tabular}{lcccccc}\toprule
     \textbf{} & \textbf{točna vrednost} & \textbf{približek}  \\ \midrule
         red               &1 &2 &3 &4   &5         &6 \\
...
R. Schroeppel leta 1973 (glej Garder \cite{gardner}).
